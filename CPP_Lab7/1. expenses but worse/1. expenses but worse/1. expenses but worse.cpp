...
int main()
{
    ...
    else if (vt == week[7-rows]) {
        min_day = "vt";
    }
    else if (sr == week[7 - rows]) {
        min_day = "sr";
    }
    else if (cht == week[7 - rows]) {
        min_day = "cht";
    }
    else if (pt == week[7 - rows]) {
        min_day = "pt";
    }
    else if (sb == week[7 - rows]) {
        min_day = "sb";
    }
    else {
        min_day = vs;
